...
#contactform input{
    ...
    <div id="contactform" style="background: <?php echo $backgroundcolor; ?>;border:none/*1px solid*/ <?php //echo $inputfield_border; ?>;">
        <form name="contactform" id="form" method="post" action="<?php $_SERVER['PHP_SELF']?>">
            ...
            <div style="border-bottom: 1px solid <?php echo $inputfield_border; ?>;border-top: 1px solid <?php echo $inputfield_border; ?>;padding-bottom: 2px;padding-top: 10px;">
                ...
                <?php echo '<b style="font-size:16px;font-family:calibri">'.$varone.' + '.$vartwo.' =</b>'; ?>
                <input id="human_test" name="human_test" size="4" type="text" class="text" style="border:1px solid <?php echo $inputfield_border; ?>;"><br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                <tr>
                    <td width="20%" valign="top">
                        <input type="submit" name="submit" value="<?php echo strtoupper(JText::_('MOD_JDCONTACT_SUBMIT')); ?>" id="submit" />
                    </td>
