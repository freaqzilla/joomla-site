...
if ($ext_load_scripts == 0) {
	...
	if ($ext_load_validate  > 0) {
		$document->addScript(JURI::base() . 'modules/mod_ext_quick_contact_form_jquery/assets/js/jquery.validate.min.js');
		}
